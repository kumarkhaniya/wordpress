			...
			<?php if ( count( $notifications ) ): ?>
				<?php foreach ( $notifications as $notification ): ?>
					...
					<tr id="notification-<?php echo $notification->id; ?>">
						<td class="column-time"><?php echo date( $date_time_format, $notification->time ); ?></td>
						...
						<p>
							...
							<label>
								<input id="ml_push_notification_android" type="radio" name='ml_push_notification_os'
									value="android"/> Android only <?php if (!is_null($registeredDevicesCount['android'])) {?>(<?php echo $android_count; ?> devices)<?php } ?>
							</label><br/>
							<label>
								<input id="ml_push_notification_ios" type="radio" name='ml_push_notification_os'
									value="ios"/> iOS only <?php if (!is_null($registeredDevicesCount['ios'])) {?>(<?php echo $ios_count; ?> devices)<?php } ?>
							</label>
						</p>
						<?php
